...
//Todo: Donner la possibilité au vendeur d'autoriser soit l'achat soit l'echange soit les deux

//Todo: prix est initialiser à 0 pour les echanges

//Todo: plantage de l'appli lors de création de produit

//Todo: rendre invisible @ et € pour les nouveaux produits

//Todo: Après création du produit ouvrir la fenetre des messages, après message envoyer retour sur carte ou liste

//Todo: un fois @ ou € appuyer il faut les desactiver pendant le chargement
