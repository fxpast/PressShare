...
class MyProfilTableViewContr : UITableViewController ,UITextFieldDelegate,  UIAlertViewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        IBPseudo.layer.addSublayer(MyTools.sharedInstance.createLine(frame: IBPseudo.frame))
        ...
        IBNickName.layer.addSublayer(MyTools.sharedInstance.createLine(frame: IBNickName.frame))
        ...
        IBSurname.layer.addSublayer(MyTools.sharedInstance.createLine(frame: IBSurname.frame))
        ...
        IBAdresse.layer.addSublayer(MyTools.sharedInstance.createLine(frame: IBAdresse.frame))
        ...
        IBZipCode.layer.addSublayer(MyTools.sharedInstance.createLine(frame: IBZipCode.frame))
        ...
        IBCity.layer.addSublayer(MyTools.sharedInstance.createLine(frame: IBCity.frame))
        ...
        IBCountry.layer.addSublayer(MyTools.sharedInstance.createLine(frame: IBCountry.frame))
    ...
    @IBAction func actionHelp(_ sender: Any) {
        ...
        //action info
        MyTools.sharedInstance.showHelp("MyProfilTableViewContr", self)
