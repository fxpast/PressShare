...
//Todo: Créer pressshareprod.fxpast.com
//Todo: Créer presssharedev.fxpast.com
//Todo: Créer dbpressshareprod pour la base de donnée
//Todo: Créer dbpresssharedev pour la base de donnée
//Todo: Créer une table Config dans la base de données pour centraliser la config générale de l’appli.
...
//Todo: factoriser les paramètres de connexion dans php
