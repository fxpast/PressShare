...
class DetailTransViewController: UIViewController {
    ...
    override func viewDidLoad() {
      ...
      IBisConfirm.isOn = false
        ...
        IBAmount.text = "\(translate.message("amount")) \(MyTools.sharedInstance.formatedAmount(aTransaction!.trans_amount))"
    ...
    @IBAction func actionHelp(_ sender: Any) {
        ...
        //action info
        MyTools.sharedInstance.showHelp("DetailTransViewController", self)
